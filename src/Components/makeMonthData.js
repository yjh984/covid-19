...
function makeMonthData(searchNations,normalize,dataArray) {
  ...
  dataArray.forEach((a,i)=>{
    ...
    for (let i=monthData.length; i<6; i++){
    ...
    const completedAccMonth={
      ...
      datasets:[
        ...
        {
          label: monthData[1]===undefined? 'N/A':`${searchNations[1]}`,
        ...
        {
          label: monthData[2]===undefined? 'N/A':`${searchNations[2]}`,
        ...
        {
          label: monthData[3]===undefined? 'N/A':`${searchNations[3]}`,
        ...
        {
          label: monthData[4]===undefined? 'N/A':`${searchNations[4]}`,
        ...
        {
          label: monthData[5]===undefined? 'N/A':`${searchNations[5]}`,
          // backgroundColor:'red',
          borderColor: 'red',
          fill: false,
