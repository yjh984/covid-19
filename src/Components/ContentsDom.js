    ...
    //   console.log(dayCaseArray[1]===undefined);
      ...
      setConfirmedDay({
        ...
        datasets:[
          ...
          {
            label: dayCaseArray[1]===undefined? 'N/A':`${searchNations[1]} Trend * ${normalize[1]}`,
            borderColor: 'gray',
            fill: false,
            data: dayCaseArray[1]===undefined? null:dayCaseArray[1].map(a=>a.confirmed),
          },
         {
            label: dayCaseArray[2]===undefined? 'N/A':`${searchNations[2]} Trend * ${normalize[2]}`,
            borderColor: '#036384',
            fill: false,
            data: dayCaseArray[2]===undefined? null:dayCaseArray[2].map(a=>a.confirmed),
          },
          {
            label: dayCaseArray[3]===undefined? 'N/A':`${searchNations[3]} Trend * ${normalize[3]}`,
            borderColor: 'green',
            fill: false,
            data: dayCaseArray[3]===undefined? null:dayCaseArray[3].map(a=>a.confirmed),
          },
          {
            label: dayCaseArray[4]===undefined? 'N/A':`${searchNations[4]} Trend * ${normalize[4]}`,
            borderColor: 'black',
            fill: false,
      ...
      dataArray.forEach((a,i)=>{
        ...
        setConfirmedAccMonth({
          ...
          datasets:[
            ...
            {
              label: monthData[1]===undefined? 'N/A':`${searchNations[1]} Trend * ${normalize[1]}`,
              backgroundColor:'gray',
              borderColor: 'gray',
              fill: false,
              data: monthData[1]===undefined? null:monthData[1].map(a=>a.confirmed),
            },
            {
              label: monthData[2]===undefined? 'N/A':`${searchNations[2]} Trend * ${normalize[2]}`,
              backgroundColor:'#036384',
              borderColor: '#036384',
              fill: false,
              data: monthData[2]===undefined? null:monthData[2].map(a=>a.confirmed),
            },
            {
              label: monthData[3]===undefined? 'N/A':`${searchNations[3]} Trend * ${normalize[3]}`,
              backgroundColor:'green',
              borderColor: 'green',
              fill: false,
              data: monthData[3]===undefined? null:monthData[3].map(a=>a.confirmed),
            },
            {
              label: monthData[4]===undefined? 'N/A':`${searchNations[4]} Trend * ${normalize[4]}`,
              backgroundColor:'black',
              borderColor: 'black',
              fill: false,
              data: monthData[4]===undefined? null:monthData[4].map(a=>a.confirmed),
            },
          ]
        });
        setConfirmedMonth({
